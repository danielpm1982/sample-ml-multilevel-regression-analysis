# sample-ml-multilevel-regression-analysis
...
[**Description of this repository**]<br>This is a sample Machine Learning project that exemplifies how to proceed Hierarchical Multilevel Regression Analysis, using Python, Pandas, NumPy, SciPy, Statsmodels, Statstests, Scikit-learn, Matplotlib, Seaborn and Plotly, along with Anaconda managed environments.
...
**Student's Performance - period (month) x student (extra_class_activity) x school (professor_experience_years) x performance (HLM3 or GLMM3)**

GitHub:<br>[https://github.com/danielpm1982/sample-ml-multilevel-regression-analysis/blob/master/regression-analysis-multilevel-hlm3-student-performance.ipynb](https://github.com/danielpm1982/sample-ml-multilevel-regression-analysis/blob/master/regression-analysis-multilevel-hlm3-student-performance.ipynb)<br>
Colab:<br>[https://colab.research.google.com/github/danielpm1982/sample-ml-multilevel-regression-analysis/blob/master/regression-analysis-multilevel-hlm3-student-performance.ipynb](https://colab.research.google.com/github/danielpm1982/sample-ml-multilevel-regression-analysis/blob/master/regression-analysis-multilevel-hlm3-student-performance.ipynb)<br>

**Trend in Probability of Traveling - age x numb_of_kids x goes_travel (HLR or logistic GLMM | HLM)**

GitHub:<br>[https://github.com/danielpm1982/sample-ml-multilevel-regression-analysis/blob/master/regression-analysis-multilevel-hlr-travel.ipynb](https://github.com/danielpm1982/sample-ml-multilevel-regression-analysis/blob/master/regression-analysis-multilevel-hlr-travel.ipynb)<br>
Colab:<br>[https://colab.research.google.com/github/danielpm1982/sample-ml-multilevel-regression-analysis/blob/master/regression-analysis-multilevel-hlr-travel.ipynb](https://colab.research.google.com/github/danielpm1982/sample-ml-multilevel-regression-analysis/blob/master/regression-analysis-multilevel-hlr-travel.ipynb)<br>

[**Source Code and Run**]<br>
Source code available at github.com, through the following link:<br>
[https://github.com/danielpm1982/sample-ml-multilevel-regression-analysis](https://github.com/danielpm1982/sample-ml-multilevel-regression-analysis) <br>
